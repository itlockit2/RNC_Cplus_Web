	...
	<body>
		...
		<div class="container">
           ...
           <a href="AudiR8.php" class="list-group-item">
			...
			<img class="media-object" src="images/AudiR8.jpg" alt="아우디R8 이미지">
      <?php
       $result = mysqli_query($conn, "SELECT * FROM foreigncar WHERE foreigncar.Name = 'Audi R8'");
       $row = mysqli_fetch_assoc($result);
       ...
       ?>
          ...
          <?php
          $result = mysqli_query($conn, "SELECT * FROM foreigncarspec WHERE foreigncarspec.Name = 'Audi R8'");
          $row = mysqli_fetch_assoc($result);
