	...
	<body>
		...
		<div class="container">
           ...
           <a href="AudiR8.php" class="list-group-item">
			...
			<img class="media-object" src="images/Enzoferrari.jpg" alt="Enzo Ferrari 이미지">
      <?php
       $result = mysqli_query($conn, "SELECT * FROM foreigncar WHERE foreigncar.Name = 'Enzo Ferrari'");
       $row = mysqli_fetch_assoc($result);
       ...
       ?>
          ...
          <?php
          $result = mysqli_query($conn, "SELECT * FROM foreigncarspec WHERE foreigncarspec.Name = 'Enzo Ferrari'");
          $row = mysqli_fetch_assoc($result);
