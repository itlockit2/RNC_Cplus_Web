    	...
    	<div class="row">
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<hr>
					<?php
					$sql = "SELECT title,contents,image_file,rink FROM code WHERE lecture_no=$lecture_number";
					$result = mysqli_query($conn,$sql);
					
					while($row = mysqli_fetch_array($result)){
						echo "<h3>"; echo"{$row['title']}"; echo"</h3>";
						echo "<hr>";
						echo "<h3>"; echo"{$row['contents']}"; echo"</h3>";
						echo "<hr>";
						echo "<h3> 출력예제 </h3>";
						echo "<img class='img-responsive' src='"; echo "{$row['image_file']}'>";
						echo "<br>";
						echo "<br>";
						echo "<br>";
						echo "{$row['rink']}";
